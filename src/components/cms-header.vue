<template>
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index.html">ISS-内容管理系统</a>
    </div>
    <!-- /.navbar-header -->

    <ul id="header-nav-right" class="nav navbar-top-links navbar-right">
      <li class="dropdown">
...
<script>
import containerMenu from './container-menu.vue'
export default {
  components: {
